...
if __name__ == '__main__':
	r_st = "run"
	epoches = 30
	for ep_idx in range(0,epoches):
		if(ep_idx == (epoches-1)): r_st = "stop"
		main(ep_idx,r_st)